...
p <- ggplot(DiffProf, aes(x = x, y = TiO2)) +
  ...
  theme_bw()
ggsave("SpDis12TiO2DiffusionProfile.png", width = 2000, height = 2*618, units = "px", plot = p)
...
ggsave("SpDis12TiO2InverseErfDiffusionProfile.png", width = 2000, height = 2*618, units = "px", plot = p)
