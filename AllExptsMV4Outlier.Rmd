...
Outliers identified using Bonferroni p-values for testing each observation in turn to be a mean-shift outlier, based Studentized residuals in linear (t-tests) model. Outliers have Bonferroni p < 0.05. Row numbers of the outliers are returned. Those experiments are deleted and the model rerun and tested for outliers.

```{r}
DelExpts <- c("SpDis_1", "SpDis_3")
...
No remaining experiments have Bonferroni p < 0.05. 
